...
from dctkit.mesh import util as u
import pygmsh
from typing import Tuple, List
import numpy.typing as npt
from util import save_datasets
...
def get_data(
    ...
    X = np.zeros((tot_num_data, S.num_nodes, 3), dtype=dt.float_dtype)
...
if __name__ == "__main__":
    ...
    S = u.build_complex_from_mesh(mesh)
    S.get_hodge_star()
    ...
    save_datasets(
        ...
        data_generator_kwargs={
            ...
            "bench_names": ["pure_tension", "pure_shear"],
        },
        perc_val=0.3,
        perc_test=0.2,
        format="npy",
